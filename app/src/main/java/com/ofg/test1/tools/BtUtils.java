package com.ofg.test1.tools;

import android.bluetooth.BluetoothClass;

import com.ofg.test1.R;
...
public class BtUtils {
    ...
    public static int getDeviceType(BluetoothClass bluetoothClass) {
        ...
        switch (bluetoothClass.getMajorDeviceClass()) {
            ...
            default:
                if (BtUtils.doesClassMatch(bluetoothClass, PROFILE_HEADSET))
                    return R.drawable.ic_headset;
                else if (BtUtils.doesClassMatch(bluetoothClass, PROFILE_A2DP)) {
                    return R.drawable.ic_smartphone;
                } else {
                    return R.drawable.ic_bluetooth;
                }
